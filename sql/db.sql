...
INSERT INTO flyapi.interface_info (id, name, description, bashUrl, port, path, requestBody, requestHeader, responseHeader, status, method, userId, demo, createTime, updateTime, isDelete) VALUES (3, '网易云获取歌词接口', '通过传入参数{id:number}查询该编号对应的歌曲歌词', 'http://localhost', 3000, '/api/wyy/lyric', '{id:number}', null, null, 1, 'POST', 1, '{"id":33894312}', '2023-04-18 23:12:38', '2023-04-19 15:53:59', 0);

-- 插入用户信息
INSERT INTO flyapi.user (id, userName, userAccount, userAvatar, gender, userRole, userPassword, accessKey, secretKey, createTime, updateTime, isDelete) VALUES (1, 'admin', 'admin', 'https://tupian.qqw21.com/article/UploadPic/2020-10/202010272223486473.jpg', null, 'admin', '9d6541b97bbfb4cf352fc68c5e66d88f', '882564ad7dc78a11ab87367b5579e4ad', '3a342a60424bc0d7a35cc4b8bfa0be63', '2023-04-17 20:09:23', '2023-04-19 11:00:47', 0);
...
INSERT INTO flyapi.user (id, userName, userAccount, userAvatar, gender, userRole, userPassword, accessKey, secretKey, createTime, updateTime, isDelete) VALUES (5, 'hahaha', 'hahaha', 'https://tupian.qqw21.com/article/UploadPic/2020-10/202010272223486473.jpg', null, 'admin', '9d6541b97bbfb4cf352fc68c5e66d88f', '28618691ed24967c9a92391d5318af0e', '4eb4231ead40023781ab4dbe25f48f0f', '2023-04-19 20:52:41', '2023-04-19 20:55:49', 0);
