...
insert into flyapi.`interface_info` (`name`, `description`, Url, `requestHeader`, `responseHeader`, `status`, `method`,
                                     `userId`)
...
-- 接口信息
create table if not exists flyapi.`interface_info_demo`
(
    `id`             bigint                             not null auto_increment comment '主键' primary key,
    `name`           varchar(256)                       not null comment '名称',
    `description`    varchar(256)                       null comment '描述',
